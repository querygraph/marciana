...
| Clients | Rust/Python/JavaScript fixture versions | Rust wire fixture `api_remember_v1`, Python client `0.1.0` (Pydantic `>=2.7,<3`), and TypeScript client `0.1.0` (Node ESM, TypeScript `^5.7`) are independently buildable; coordinated release publication remains pending |
